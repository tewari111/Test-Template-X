...
var Autocomplete = React2.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => (0, import_jsx_runtime2.jsx)(Chip_default, _extends({
  ...
  return (0, import_jsx_runtime3.jsxs)(React2.Fragment, {
    children: [(0, import_jsx_runtime2.jsx)(AutocompleteRoot, _extends({
      ref,
      ...
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: (0, import_jsx_runtime3.jsxs)(AutocompleteEndAdornment, {
            ...
            ownerState,
            children: [hasClearIcon ? (0, import_jsx_runtime2.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? (0, import_jsx_runtime2.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? (0, import_jsx_runtime2.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime3.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime2.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
//# sourceMappingURL=chunk-4A7KZ74P.js.map
